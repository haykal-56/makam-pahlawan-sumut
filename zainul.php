...
<body>
    ...
    <div class="text-center">
        <img src="https://sumutprov.go.id/images/untukmasyarakat/ZainulArifin.jpg" width="250" height="250" alt="...">
    </div>
    <br>
    <div class="container">
      <h3 class="col-sm-4" >Sejarah singkat</h3>
      <p class="col-sm-12">
          Ia dikenal sebagai ulama, politis, pejuang 1945, Panglima Hizbullah, dan ketua DPR-GR (1960-1963). Zainul Arifin lahir sebagai anak tunggal dari pasangan keturunan raja Barus, Sultan Ramali bin Tuangku Raja Barus Sultan Sahi Alam Pohan (ayah) dengan bangsawan asal Kotanopan, Mandailing Natal, Siti Baiyah Nasution. Ketika Zainul masih balita, kedua orang tuanya bercerai dan ia dibawa pindah oleh ibunya ke Kotanopan, kemudian ke Kerinci, Jambi. Disana ia menyelesaikan Hollands Indische School (HIS) dan sekolah menengah calon guru, Normal School. 
      </p>
      <p class="col-sm-12">
