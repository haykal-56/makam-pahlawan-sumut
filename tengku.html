...
<div class="text-center">
    <img src="https://sumutprov.go.id/images/untukmasyarakat/TAmirHamzah.jpg" width="250" height="250" alt="...">
</div>
<br>
<div class="container">
  ...
  <p class="col-sm-12 text-justify">
      Dimakamkan di Tanjung Pura, Langkat
  </p>
  <h3 class="col-sm-4" >Lokasi pemakaman</h3>
  <br>
  <div class="text-center">
      <img src="../amir hamzah.png" width="80%" class="rounded" alt="">
  </div>
  <div class="" id="map"></div>
  </div>
</div>
<script>
    var map = L.map('map').setView([3.8915214,98.4240843], 15);
    var marker = L.marker([3.8915214,98.4240843]).addTo(map);
